...
public final class ShaderTest extends AbstractTest {
    ...
    public void testRenderSceneWithNoShadows() throws TimeoutException {
        ...
        assertRenderScene(Scene.OBJ, Shader.NO_SHADOWS, Accelerator.REG_GRID, 1, 1, false, false);
    }
    ...
    public void testRenderSceneWithDepthMap() throws TimeoutException {
        ...
        assertRenderScene(Scene.OBJ, Shader.DEPTH_MAP, Accelerator.REG_GRID, 1, 1, false, false);
    }
    ...
    public void testRenderSceneWithDiffuse() throws TimeoutException {
        ...
        assertRenderScene(Scene.OBJ, Shader.DIFFUSE, Accelerator.REG_GRID, 1, 1, false, false);
    }
