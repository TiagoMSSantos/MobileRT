...
public class MemoryTest {
     ...
     */
    @Test
    public void testAllocatingHeapMemory() {
        final String methodName = Thread.currentThread().getStackTrace()[2].getMethodName();
        LOGGER.info(methodName);
        ...
        final long firstAvailableMemoryMB = getAvailableMemoryInMB();
        ...
        final long startAvailableMemory = getAvailableMemoryInMB();
