...
namespace MobileRT {
    ...
    public:
        ...
        explicit RegularGrid(::std::vector<::MobileRT::Primitive<T>> &&primitives,::std::uint32_t gridSize) noexcept;
    ...
    RegularGrid<T>::RegularGrid(
        ::std::vector<::MobileRT::Primitive<T>> &&primitives, const ::std::uint32_t gridSize
    ) noexcept :
        grid_ {
