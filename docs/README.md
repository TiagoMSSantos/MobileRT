...
- [Android SDK](https://developer.android.com/studio) which should also bring the [Android NDK](https://developer.android.com/ndk) in order to compile the native code.
  - It's recommended to use the Android Studio `2022.2.1` which is compatible with Gradle [7.3.1](https://github.com/TiagoMSSantos/MobileRT/blob/master/build.gradle#L65?) used by this project.
